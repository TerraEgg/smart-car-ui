// Interactive control panel for managing hardware-level vehicle functions like engine, lights, doors, and climate.
...
export const VehicleControls: React.FC = () => {
  ...
  const getNextWipers = () => {
    const wipers: Array<"off" | "slow" | "medium" | "fast"> = [
      "off",
      "slow",
      "medium",
      "fast",
  ...
  return (
    <div className="vehicle-controls">
        ...
        <div className="button-group">
          {(["P", "R", "N", "D"] as const).map((gear) => (
            <button
              ...
              className={`control-btn gear ${
                state.gear === gear ? "active" : ""
              }`}
            >
              {gear}
            </button>
      ...
      <div className="control-section">
        <h3>Lights</h3>
        <button onClick={handleToggleLights} className="control-btn lights">
          {state.lights === "off"
            ? "Off"
            : state.lights.charAt(0).toUpperCase() + state.lights.slice(1)}
        </button>
      </div>
      <div className="control-section">
        <h3>Wipers</h3>
        <button onClick={handleToggleWipers} className="control-btn wipers">
          {state.wipers === "off"
            ? "Off"
            : state.wipers.charAt(0).toUpperCase() + state.wipers.slice(1)}
        </button>
      </div>
      <div className="control-section">
        <h3>Seat Heat</h3>
            ...
            <div className="button-group-inline">
              {[0, 1, 2, 3].map((level) => (
                <button
                  key={level}
                  onClick={() =>
                    handleSetSeatHeat("driver", level as 0 | 1 | 2 | 3)
                  }
                  className={`control-btn heat ${
                    state.seatHeat.driver === level ? "active" : ""
                  }`}
                >
                  {level === 0 ? "Off" : level}
                </button>
            ...
            <div className="button-group-inline">
              {[0, 1, 2, 3].map((level) => (
                <button
                  key={level}
                  onClick={() =>
                    handleSetSeatHeat("passenger", level as 0 | 1 | 2 | 3)
                  }
                  className={`control-btn heat ${
                    state.seatHeat.passenger === level ? "active" : ""
                  }`}
                >
                  {level === 0 ? "Off" : level}
                </button>
            ...
            <div className="button-group-inline">
              {[0, 1, 2, 3].map((level) => (
                <button
                  ...
                  className={`control-btn heat ${
                    state.seatHeat.rearLeft === level ? "active" : ""
                  }`}
                >
                  {level === 0 ? "Off" : level}
                </button>
            ...
            <div className="button-group-inline">
              {[0, 1, 2, 3].map((level) => (
                <button
                  ...
                  className={`control-btn heat ${
                    state.seatHeat.rearRight === level ? "active" : ""
                  }`}
                >
                  {level === 0 ? "Off" : level}
                </button>
      ...
      <div className="control-section">
        ...
        <div className="button-group">
          <button
            ...
            className={`control-btn door ${
              state.doors.frontLeft ? "open" : "closed"
            }`}
          >
          ...
          <button
            ...
            className={`control-btn door ${
              state.doors.frontRight ? "open" : "closed"
            }`}
          >
      ...
      <div className="control-section">
        ...
        <div className="button-group">
          <button
            ...
            className={`control-btn window ${
              state.windows.frontLeft ? "open" : "closed"
            }`}
          >
          ...
          <button
            ...
            className={`control-btn window ${
              state.windows.frontRight ? "open" : "closed"
            }`}
          >
        ...
        <div className="button-group">
          {["clear", "cloudy", "rainy", "snowy"].map((w) => (
            <button
              ...
              onClick={() =>
                setWeather(
                  w as "clear" | "cloudy" | "rainy" | "snowy" | "foggy"
                )
              }
              className={`control-btn weather ${
                state.weather === w ? "active" : ""
              }`}
            >
