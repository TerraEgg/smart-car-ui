// Main application component that manages layout, mobile support, and global state providers.
import "./App.css";
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            This web app is not supported on mobile devices. Please use a
            desktop or laptop computer to access this application.
          </div>
        </div>
      </div>
    );
