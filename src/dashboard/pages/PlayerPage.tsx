// Media player interface that allows switching between terrestrial radio and online streaming services.
        ...
        >
          ...
          >
            {playbackSource === "radio" ? (
              <Radio size={20} color="#6b4a5a" />
            ) : (
              <Music size={20} color="#6b4a5a" />
            )}
            <div>
